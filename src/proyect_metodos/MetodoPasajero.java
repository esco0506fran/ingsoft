...
public class MetodoPasajero {
    ...
    public void guardarArchivoPasajero(Pasajero pasajero){
        ...
        try {
            FileWriter fw = new FileWriter ("C:/Users/franc/Documents/Guardar datos/pasajero.txt", true);
    ...
    public DefaultTableModel listaPasajero(){
        ...
        try {
            ...
            FileReader fr = new FileReader("C:/Users/franc/Documents/Guardar datos/pasajero.txt");
